...
public class EncryptionUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encryptedData = encrypt(masterKey, "Key has been encrypted");
        System.out.println("Encrypted: " + encryptedData);
        String decryptedText = decrypt("Gl9YZtPY7K9Affq4fJibSqyIvUKf/YQVNhtQc6tEpvb6XVSLf7ikc22xKnNki5IWcg==", masterKey);
